...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Organization', fields ['codename']
        db.delete_unique(u'nirit_organization', ['codename'])


        # Changing field 'UserProfile.codename'
        db.alter_column(u'nirit_userprofile', 'codename', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.codename'
        db.alter_column(u'nirit_userprofile', 'codename', self.gf('django.db.models.fields.CharField')(default='', max_length=64, unique=True))
        # Adding unique constraint on 'Organization', fields ['codename']
        db.create_unique(u'nirit_organization', ['codename'])

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('nirit_organization', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Organization.image'
        db.alter_column('nirit_organization', 'image', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'OToken.nirit'
        db.delete_column(u'nirit_otoken', 'nirit_id')

        # Adding field 'OToken.user'
        db.add_column(u'nirit_otoken', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'OToken.nirit'
        db.add_column(u'nirit_otoken', 'nirit',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'OToken.user'
        db.delete_column(u'nirit_otoken', 'user_id')
    ...
    models = {
        ...
        u'nirit.userprofile': {
            ...
            'building': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['nirit.Building']", 'null': 'True', 'blank': 'True'}),
            'company': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'company'", 'null': 'True', 'to': u"orm['nirit.Organization']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

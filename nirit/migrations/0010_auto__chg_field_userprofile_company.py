...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'nirit_userprofile', 'company_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['nirit.Organization']))

    def backwards(self, orm):

        # Changing field 'UserProfile.company'
        db.alter_column(u'nirit_userprofile', 'company_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['nirit.Organization']))
    ...
    models = {
        ...
        u'nirit.userprofile': {
            ...
            'company': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'company'", 'null': 'True', 'to': u"orm['nirit.Organization']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

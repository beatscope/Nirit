...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Membership.date_joined'
        db.add_column(u'nirit_membership', 'date_joined',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2014, 2, 4, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Membership.date_joined'
        db.delete_column(u'nirit_membership', 'date_joined')
    ...
    models = {
        ...
        u'nirit.membership': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'member': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['nirit.UserProfile']"}),
        ...
        u'nirit.userprofile': {
            ...
            'spaces_joined': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'spaces'", 'to': u"orm['nirit.Space']", 'through': u"orm['nirit.Membership']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),

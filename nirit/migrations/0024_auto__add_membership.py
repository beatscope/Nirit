...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'nirit_membership', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('space', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nirit.Space'])),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nirit.UserProfile'])),
            ('status', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'nirit', ['Membership'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'nirit_membership')

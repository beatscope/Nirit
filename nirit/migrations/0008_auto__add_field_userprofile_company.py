...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'nirit_userprofile', 'company',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='company', to=orm['nirit.Organization']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding M2M table for field members on 'Organization'
        db.create_table(u'nirit_organization_members', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('organization', models.ForeignKey(orm[u'nirit.organization'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(u'nirit_organization_members', ['organization_id', 'user_id'])

        # Deleting field 'UserProfile.company'
        db.delete_column(u'nirit_userprofile', 'company_id')

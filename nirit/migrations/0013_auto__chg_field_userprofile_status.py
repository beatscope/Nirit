...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'nirit_userprofile', 'status', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.status'
        db.alter_column(u'nirit_userprofile', 'status', self.gf('django.db.models.fields.IntegerField')())

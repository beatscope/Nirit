...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyProfile.directions'
        db.add_column(u'nirit_companyprofile', 'directions',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyProfile.directions'
        db.delete_column(u'nirit_companyprofile', 'directions')

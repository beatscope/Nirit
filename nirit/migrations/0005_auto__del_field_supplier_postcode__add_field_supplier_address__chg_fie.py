...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Supplier.postcode'
        db.delete_column(u'nirit_supplier', 'postcode')

        # Adding field 'Supplier.address'
        db.add_column(u'nirit_supplier', 'address',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Supplier.slug'
        db.alter_column(u'nirit_supplier', 'slug', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):
        # Adding field 'Supplier.postcode'
        db.add_column(u'nirit_supplier', 'postcode',
                      self.gf('django.db.models.fields.CharField')(max_length=8, null=True),
                      keep_default=False)

        # Deleting field 'Supplier.address'
        db.delete_column(u'nirit_supplier', 'address')


        # Changing field 'Supplier.slug'
        db.alter_column(u'nirit_supplier', 'slug', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

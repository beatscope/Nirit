...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Supplier.description'
        db.add_column(u'nirit_supplier', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Supplier.description'
        db.delete_column(u'nirit_supplier', 'description')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Space.use_building'
        db.add_column(u'nirit_space', 'use_building',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Space.use_floor'
        db.add_column(u'nirit_space', 'use_floor',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'CompanyProfile.building'
        db.add_column(u'nirit_companyprofile', 'building',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Space.use_building'
        db.delete_column(u'nirit_space', 'use_building')

        # Deleting field 'Space.use_floor'
        db.delete_column(u'nirit_space', 'use_floor')

        # Deleting field 'CompanyProfile.building'
        db.delete_column(u'nirit_companyprofile', 'building')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field buildings on 'Supplier'
        db.create_table(u'nirit_supplier_buildings', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('supplier', models.ForeignKey(orm[u'nirit.supplier'], null=False)),
            ('building', models.ForeignKey(orm[u'nirit.building'], null=False))
        ))
        db.create_unique(u'nirit_supplier_buildings', ['supplier_id', 'building_id'])


    def backwards(self, orm):
        # Removing M2M table for field buildings on 'Supplier'
        db.delete_table('nirit_supplier_buildings')

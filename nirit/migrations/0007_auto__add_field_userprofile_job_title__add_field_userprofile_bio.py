...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'nirit_userprofile', 'job_title',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.bio'
        db.add_column(u'nirit_userprofile', 'bio',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'nirit_userprofile', 'job_title')

        # Deleting field 'UserProfile.bio'
        db.delete_column(u'nirit_userprofile', 'bio')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('nirit_building', 'nirit_space')
        db.rename_table('nirit_building_notices', 'nirit_space_notices')
        db.rename_table('nirit_supplier_buildings', 'nirit_supplier_spaces')

    def backwards(self, orm):
        db.rename_table('nirit_space', 'nirit_building')
        db.rename_table('nirit_space_notices', 'nirit_building_notices')
        db.rename_table('nirit_supplier_spaces', 'nirit_supplier_buildings')

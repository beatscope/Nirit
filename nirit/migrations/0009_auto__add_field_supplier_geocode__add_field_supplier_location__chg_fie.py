...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Supplier.geocode'
        db.add_column(u'nirit_supplier', 'geocode',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nirit.Geocode'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Supplier.location'
        db.add_column(u'nirit_supplier', 'location',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Supplier.address'
        db.alter_column(u'nirit_supplier', 'address', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

    def backwards(self, orm):
        # Deleting field 'Supplier.geocode'
        db.delete_column(u'nirit_supplier', 'geocode_id')

        # Deleting field 'Supplier.location'
        db.delete_column(u'nirit_supplier', 'location')


        # Changing field 'Supplier.address'
        db.alter_column(u'nirit_supplier', 'address', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    ...
    models = {
        ...
        u'nirit.supplier': {
            ...
            'buildings': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['nirit.Building']", 'null': 'True', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'nirit_supplier', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('slug', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('postcode', self.gf('django.db.models.fields.CharField')(max_length=8, null=True)),
            ('type', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'nirit', ['Supplier'])


    def backwards(self, orm):
        # Deleting model 'Supplier'
        db.delete_table(u'nirit_supplier')
    ...
    models = {
        ...
        u'nirit.supplier': {
            ...
            'postcode': ('django.db.models.fields.CharField', [], {'max_length': '8', 'null': 'True'}),

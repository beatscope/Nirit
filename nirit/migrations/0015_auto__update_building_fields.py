...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('nirit_space_notices', 'building_id', 'space_id')
        db.rename_column('nirit_userprofile', 'building_id', 'space_id')
        db.rename_column('nirit_supplier_spaces', 'building_id', 'space_id')
        db.rename_column('nirit_otoken', 'building_id', 'space_id')
        db.rename_column('nirit_companyprofile', 'building_id', 'space_id')

    def backwards(self, orm):
        db.rename_column('nirit_space_notices', 'space_id', 'building_id')
        db.rename_column('nirit_userprofile', 'space_id', 'building_id')
        db.rename_column('nirit_supplier_spaces', 'space_id', 'building_id')
        db.rename_column(u'nirit_otoken', 'space_id', 'building_id')
        db.rename_column(u'nirit_companyprofile', 'space_id', 'building_id')
    ...
    models = {
        ...
        u'nirit.userprofile': {
            ...
            'space': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['nirit.Space']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),

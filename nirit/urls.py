...
urlpatterns = patterns('',
    ...
    url(r'^spaces/awaiting-approval$', 'nirit.views_public.spaces_awaiting_approval'),
    ...
    url(r'^join/[\w-]*/(?P<codename>\w+)/', 'nirit.views.join', name='join'),
    ...
    url(r'^member/spaces/$', 'nirit.views_member.spaces'),
    ...
    url(r'^approval/unaffiliated/(?P<id>\d+)/(?P<action>\w+)$', 'nirit.views_member.set_unaffiliated_status'),
